...
/**
* Script file of Managementcom component
*
* @package	Managementcom
* @subpackage	Installer
*/
class com_managementcomInstallerScript
{
	/**
	...
	*/
	...
	{
		$adapter->getParent()->setRedirectURL('index.php?option=com_managementcom');
	...
	*/
	public function postflight($type, JAdapterInstance $adapter)
	{
		...
		$txtComponent = JText::_('COM_MANAGEMENTCOM');
