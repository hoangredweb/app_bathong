...
* @subpackage	
*/
class ManagementcomCkClassControllerList extends JControllerAdmin
{
	/**
	...
	*/
	public function getModel($name = '', $prefix = 'ManagementcomModel', $config = array('ignore_request' => true))
	{
		if (empty($name))
		{
...
if (!class_exists('ManagementcomClassControllerList')){ class ManagementcomClassControllerList extends ManagementcomCkClassControllerList{} }
