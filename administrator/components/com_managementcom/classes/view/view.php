...
* @subpackage	Class
*/
class ManagementcomCkClassView extends CkJView
{
	/**
	...
	*/
	...
	{
		$this->addTemplatePath(JPATH_MANAGEMENTCOM . '/fork/views/' . $this->getName() . '/tmpl');
	}
...
if (!class_exists('ManagementcomClassView')){ class ManagementcomClassView extends ManagementcomCkClassView{} }
