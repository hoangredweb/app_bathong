...
/**
* ORM Class for Managementcom.
*
* @package	Managementcom
* @subpackage	Class
*/
class ManagementcomCkClassModelOrm
{
	/**
	* Database.
	*
	...
	*/
	...
	{
		return new ManagementcomClassModelOrm($model);
	}
	...
	*/
	...
	{
		foreach(array_reverse($config) as $namespace => $dir)
		{
...
if (!class_exists('ManagementcomClassModelOrm')){ class ManagementcomClassModelOrm extends ManagementcomCkClassModelOrm{} }
