...
/**
* Ajax Class for Managementcom.
*
* @package	Managementcom
* @subpackage	Class
*/
class ManagementcomCkClassAjax extends JObject
{
	/**
	...
	*/
	public static function responseHook($options = array(), $version)
	{
		...
		switch(strtoupper($options['renderExceptions']))
		{
			...
			case 'HTML':
				$return->transaction->htmlExceptions = ManagementcomClassView::renderMessages('HTML');
				break;

			case 'TEXT':
				$return->transaction->rawExceptions = ManagementcomClassView::renderMessages('TEXT');
				break;
			...
			default:
				...
				else
				{
					...
					$return->transaction->exceptions = ManagementcomClassView::renderMessages(null);
...
if (!class_exists('ManagementcomClassAjax')){ class ManagementcomClassAjax extends ManagementcomCkClassAjax{} }
