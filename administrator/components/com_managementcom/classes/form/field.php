...
* @subpackage	Form
*/
class ManagementcomCkClassFormField extends JFormField
{
	/**
...
if (!class_exists('ManagementcomClassFormField')){ class ManagementcomClassFormField extends ManagementcomCkClassFormField{} }
