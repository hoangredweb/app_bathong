...
/**
* JLoader Class for Managementcom.
*
* @package	Managementcom
* @subpackage	Class
*/
class ManagementcomCkClassLoader extends JLoader
{
	/**
	...
	*/
	public static function setup($enablePsr = true, $enablePrefixes = true, $enableClasses = true, $enableComponentLoader = false)
	{
		...
		if ($enableComponentLoader)
			spl_autoload_register(array('ManagementcomClassLoader', 'load'));
	}
...
if (!class_exists('ManagementcomClassLoader')){ class ManagementcomClassLoader extends ManagementcomCkClassLoader{} }
