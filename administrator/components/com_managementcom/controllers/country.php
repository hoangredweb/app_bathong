...
/**
* Managementcom Country Controller
*
* @package	Managementcom
* @subpackage	Country
*/
class ManagementcomCkControllerCountry extends ManagementcomClassControllerItem
{
	/**
		...
		switch($this->getLayout() .'.'. $this->getTask())
		{
			case 'default.add':
				$this->applyRedirection($result, array(
					'stay',
					'com_managementcom.country.country'
				), array(
	...
	public function cancel($key = null)
	{
		...
		switch($this->getLayout() .'.'. $this->getTask())
		{
			case 'country.cancel':
				$this->applyRedirection($result, array(
					'stay',
					'com_managementcom.countries.default'
				), array(
					'cid[]' => null
				));
				break;
...
if (!class_exists('ManagementcomControllerCountry')){ class ManagementcomControllerCountry extends ManagementcomCkControllerCountry{} }
