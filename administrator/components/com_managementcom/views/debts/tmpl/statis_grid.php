	...
	<table class='table' id='grid-debts'>
		<thead>
			<tr>
				...
				<th style="text-align:left">
					<?php echo JHTML::_('grid.sort',  "Nợ", 'sum_amount_debt', $listDirn, $listOrder ); ?>
				</th>

				<th style="text-align:left">
					<?php echo JHTML::_('grid.sort',  "Trả", 'sum_amount_repayment', $listDirn, $listOrder ); ?>
				</th>
		...
		for ($i=0, $n=count( $this->items ); $i < $n; $i++):
			...
			<tr class="<?php echo "row$k"; ?>">
				...
				<td style="text-align:left">
					<?php echo number_format($row->sum_amount_debt, 0, ',', '.');?>
				</td>

				<td style="text-align:left">
					<?php echo number_format($row->sum_amount_repayment, 0, ',', '.');?>
				</td>

				<td style="text-align:left">
					<?php echo number_format($row->total_debt, 0, ',', '.');?>
				</td>
			</tr>
			<?php
			$k = 1 - $k;
