...
<div class="grid_wrapper">
	<table  class='table table-striped' id='grid-productcustomers'>
		<thead>
			<tr>
				<th>
					<?php echo JText::_("MANAGEMENTCOM_FIELD_KHACH_HANG_ID"); ?>
				</th>
		...
		for ($i=0, $n=count( $this->items ); $i < $n; $i++):
			...
			$pickValue = $row->id;
			$pickLabel = $this->escape(addslashes($row->customer_id));
