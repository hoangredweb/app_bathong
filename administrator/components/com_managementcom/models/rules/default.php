...
* @subpackage	Form
*/
class ManagementcomCkFormRuleDefault extends ManagementcomClassFormRule
{
	/**
...
if (!class_exists('JFormRuleDefault')){ class JFormRuleDefault extends ManagementcomCkFormRuleDefault{} }
