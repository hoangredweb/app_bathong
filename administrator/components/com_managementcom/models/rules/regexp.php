...
* @subpackage	Form
*/
class ManagementcomCkFormRuleRegexp extends ManagementcomClassFormRule
{
	/**
...
if (!class_exists('JFormRuleRegexp')){ class JFormRuleRegexp extends ManagementcomCkFormRuleRegexp{} }
