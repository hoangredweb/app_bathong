...
* @subpackage	Form
*/
class ManagementcomCkFormRuleFile extends ManagementcomClassFormRule
{
	/**
	...
	*/
	public function getJsonRule($field)
	{
		...
		if ($msgIncorrect = $field->getAttribute('msg-incorrect'))
			...
			$values["alertText"] = LI_PREFIX . JText::sprintf('MANAGEMENTCOM_ERROR_ALLOWED_FILES', $allowedExtensionsText);
...
if (!class_exists('JFormRuleFile')){ class JFormRuleFile extends ManagementcomCkFormRuleFile{} }
