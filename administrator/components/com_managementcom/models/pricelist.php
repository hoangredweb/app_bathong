...
* @subpackage	Classes
*/
class ManagementcomCkModelPricelist extends ManagementcomClassModelItem
{
	/**
	* View list alias
	*
	...
	*/
	public function getLayout()
	{
		...
		return $jinput->get('layout', 'pricelist', 'STRING');
	}
	...
	*/
	public function getTable($type = 'pricelist', $prefix = 'ManagementcomTable', $config = array())
	{
	...
	*/
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_managementcom.edit.pricelist.data', array());
		...
		if (empty($data)) {
			...
			if ($this->getState('pricelist.id') == 0)
			{
				$jinput = JFactory::getApplication()->input;
	...
	/**
	* ORM Predefined profile for 'layout.pricelist'
	*
	* @access	protected
	*
	*
	...
	* @return	void
	*/
	protected function ormLayoutpricelist()
	{
		$this->orm(array(
			'select' => array(
				'name',
	...
	* @param	integer	$pk	The primary id key of the pricelist
	*
	* @return	void
	*/
	...
	{
		//FROM : Main table
		$query->from('#__managementcom_pricelists AS a');
	...
	*/
	public function update($object){
        $result = JFactory::getDbo()->updateObject('#__managementcom_pricelists', $object, 'id');
    }	
}
...
if (!class_exists('ManagementcomModelPricelist')){ class ManagementcomModelPricelist extends ManagementcomCkModelPricelist{} }
