...
* @subpackage	Form
*/
class ManagementcomCkFormFieldCktext extends ManagementcomClassFormField
{
	/**
	* The form field type.
	*
...
if (!class_exists('JFormFieldCktext')){ class JFormFieldCktext extends ManagementcomCkFormFieldCktext{} }
