...
* @subpackage	Form
*/
class ManagementcomCkFormFieldEnum extends JFormFieldGroupedList
{
	/**
	* Items cache.
	*
	...
	*/
	protected function getItems()
	{
		if (!self::$_items)
		{
			...
			self::$_items = ManagementcomHelperEnum::_($enumName);
		}
...
if (!class_exists('JFormFieldEnum')){ class JFormFieldEnum extends ManagementcomCkFormFieldEnum{} }
