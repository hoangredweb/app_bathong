...
* @subpackage	Form
*/
class ManagementcomCkFormFieldCklimit extends ManagementcomClassFormField
{
	/**
	* The form field type.
	*
...
if (!class_exists('JFormFieldCklimit')){ class JFormFieldCklimit extends ManagementcomCkFormFieldCklimit{} }
