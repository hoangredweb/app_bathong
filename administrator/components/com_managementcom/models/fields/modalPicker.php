...
* @subpackage	Form
*/
class ManagementcomCkFormFieldModalPicker extends JFormField
{
	/**
	* Extension name.
	*
	...
	*/
	protected function getSelectedLabel()
	{
		...
		$selectedItem = ManagementcomHelper::getData($model->getNameItem(), array(
...
if (!class_exists('JFormFieldModalPicker')){ class JFormFieldModalPicker extends ManagementcomCkFormFieldModalPicker{} }
