...
* @subpackage	Form
*/
class ManagementcomCkFormFieldCksearch extends ManagementcomClassFormField
{
	/**
	* The form field type.
	*
...
if (!class_exists('JFormFieldCksearch')){ class JFormFieldCksearch extends ManagementcomCkFormFieldCksearch{} }
