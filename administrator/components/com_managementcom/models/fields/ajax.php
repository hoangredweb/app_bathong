...
* @subpackage	Form
*/
class ManagementcomCkFormFieldAjax extends JFormField
{
	/**
	* Groups cache.
	*
	...
	protected function getConfig()
	{
		...
		switch($plugin)
		{
			...
			case 'field':
				...
				$config['groups'] = ManagementcomHelperForm::getElementGroups($this->element);
	...
	*/
	protected function getModel($model = null)
	{
		...
		return ManagementcomHelper::componentModel($model);
	}
...
if (!class_exists('JFormFieldAjax')){ class JFormFieldAjax extends ManagementcomCkFormFieldAjax{} }
