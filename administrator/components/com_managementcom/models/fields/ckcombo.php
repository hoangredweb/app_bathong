...
* @subpackage	Form
*/
class ManagementcomCkFormFieldCkcombo extends ManagementcomClassFormField
{
	/**
	* The form field type.
	*
...
if (!class_exists('JFormFieldCkcombo')){ class JFormFieldCkcombo extends ManagementcomCkFormFieldCkcombo{} }
