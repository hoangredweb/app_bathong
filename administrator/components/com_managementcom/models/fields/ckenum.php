...
* @subpackage	Form
*/
class ManagementcomCkFormFieldCkenum extends ManagementcomClassFormField
{
	/**
	* The form field type.
	*
...
if (!class_exists('JFormFieldCkenum')){ class JFormFieldCkenum extends ManagementcomCkFormFieldCkenum{} }
