...
* @subpackage	Form
*/
class ManagementcomCkFormFieldCkcalendar extends ManagementcomClassFormField
{
	/**
	* The form field type.
	*
...
if (!class_exists('JFormFieldCkcalendar')){ class JFormFieldCkcalendar extends ManagementcomCkFormFieldCkcalendar{} }
