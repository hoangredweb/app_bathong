...
* @subpackage	Form
*/
class ManagementcomCkFormFieldCkstate extends ManagementcomClassFormField
{
	/**
	* The form field type.
	*
...
if (!class_exists('JFormFieldCkstate')){ class JFormFieldCkstate extends ManagementcomCkFormFieldCkstate{} }
