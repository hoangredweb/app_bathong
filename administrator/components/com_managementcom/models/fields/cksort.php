...
* @subpackage	Form
*/
class ManagementcomCkFormFieldCksort extends ManagementcomClassFormField
{
	/**
	* The form field type.
	*
...
if (!class_exists('JFormFieldCksort')){ class JFormFieldCksort extends ManagementcomCkFormFieldCksort{} }
