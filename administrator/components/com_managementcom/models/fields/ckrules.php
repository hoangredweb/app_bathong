...
* @subpackage	Form
*/
class ManagementcomCkFormFieldCkrules extends ManagementcomClassFormField
{
	/**
	* The form field type.
	*
...
if (!class_exists('JFormFieldCkrules')){ class JFormFieldCkrules extends ManagementcomCkFormFieldCkrules{} }
