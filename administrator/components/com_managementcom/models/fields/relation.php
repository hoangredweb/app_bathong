...
* @subpackage	Form
*/
class ManagementcomCkFormFieldRelation extends JFormFieldModel
{
	/**
	* The form field type.
	*
	...
	*/
	protected function getRelation()
	{
		...
		$model = CkJModel::getInstance($modelName, 'ManagementcomModel');
...
if (!class_exists('JFormFieldRelation')){ class JFormFieldRelation extends ManagementcomCkFormFieldRelation{} }
