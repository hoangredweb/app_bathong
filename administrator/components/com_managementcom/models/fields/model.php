...
* @subpackage	Form
*/
class ManagementcomCkFormFieldModel extends JFormFieldGroupedList
{
	/**
	* Foreign Key Filter. 
	*
	...
	*/
	protected function getGroups()
	{
		...
		$listGroups = ManagementcomHelperForm::getElementGroups($this->element);
		...
		$items = ManagementcomHelperForm::getItems($this);
		...
		foreach($items as $item)
		{
			...
			{
				$val = ManagementcomHelper::parseValue($item, $labelKey);
				if ($val !== null)
	...
	*/
	protected function getOptions()
	{
		...
		if (!empty($items))
		foreach ($items as $item)
			$options[$item->$listKey] = ManagementcomHelper::parseValue($item, $labelKey);
	...
	*/
	public function prepareModel(&$model)
	{
		...
		$groups = ManagementcomHelperForm::getElementGroups($this->element);
...
if (!class_exists('JFormFieldModel')){ class JFormFieldModel extends ManagementcomCkFormFieldModel{} }
