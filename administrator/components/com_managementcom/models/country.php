...
* @subpackage	Classes
*/
class ManagementcomCkModelCountry extends ManagementcomClassModelItem
{
	/**
	* View list alias
	*
	...
	*/
	public function getLayout()
	{
		...
		return $jinput->get('layout', 'country', 'STRING');
	}
	...
	*/
	public function getTable($type = 'country', $prefix = 'ManagementcomTable', $config = array())
	{
	...
	*/
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_managementcom.edit.country.data', array());
	...
	/**
	* ORM Predefined profile for 'layout.country'
	*
	* @access	protected
	*
	*
	...
	* @return	void
	*/
	protected function ormLayoutCountry()
	{
		$this->orm(array(
			'select' => array(
				'alpha2',
...
if (!class_exists('ManagementcomModelCountry')){ class ManagementcomModelCountry extends ManagementcomCkModelCountry{} }
