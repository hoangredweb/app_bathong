...
<head>
	...
	-->
	<!--[if lt IE 9]>
		<script src="../media/jui/js/html5.js"></script> <?php//echo $header_link_color; ?>
	<![endif]-->

	<style>
		#sc-login #sc-header { 
			background-color: white <?php //echo $header_bg_color; ?>; 
			border-bottom: 10px solid rgb(234,30,55)<?php //echo $active_bg_color; ?>;
		}
...
-->
		<div id="sc-logo">
			...
			<h1 class="admin-title" style="font-family:'lucida handwriting'">Cơm Cháy Gạo Login</h1>
		</div>
	</header>
